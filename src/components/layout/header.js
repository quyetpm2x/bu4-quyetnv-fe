                    ...
                    <div class="feed-widget">
                      <ul class="list-style-none feed-body m-0 p-b-20">
                        ...
                        <li class="feed-item">
                          ...
                          New order received.
                          <span class="ms-auto font-12 text-muted">31 May</span>
                        </li>
                        <li class="feed-item">
                          ...
                          New user registered.
                          <span class="ms-auto font-12 text-muted">30 May</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="m-r-10">
                                <a class="btn btn-circle d-flex btn-info text-white" href="# ">
                                  EA
                                </a>
                              </div>
                              <div class="">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="m-r-10">
                                <a class="btn btn-circle d-flex btn-orange text-white" href="# ">
                                  MA
                                </a>
                              </div>
                              <div class="">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="m-r-10">
                                <a class="btn btn-circle d-flex btn-success text-white" href="# ">
                                  MP
                                </a>
                              </div>
                              <div class="">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="m-r-10">
                                <a class="btn btn-circle d-flex btn-purple text-white" href="# ">
                                  AA
                                </a>
                              </div>
                              <div class="">
