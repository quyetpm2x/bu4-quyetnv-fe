...
const Degree = () => {
  return (
    <div>
      {/* <div component='function(){return i("5fOv")("./".concat(n.$store.state.dynamicTemplate,"/certificat.vue")).catch((function(){return"openbadge"===n.$store.state.type?Promise.all([i.e(0),i.e(3),i.e(4),i.e(7)]).then(i.bind(null,"f5s9")):i.e(263).then(i.bind(null,"UeNI"))}))}'>
        {" "}
        <nav
          role="navigation"
        ...
        >
          <ul>
            {" "}
            <li>
              <a class="menu2 matomo_download">
              <i class="fas fa-print"></i> Print
              </a>
            </li>{" "}
            <li class="toggle-icon-p-m">
              <div
                class="lds-dual-ring-b animated fadeOut animation-delay-2000"
                style={{display: "none"}}
              ></div>{" "}
        ...
        <div class="proof-drawer closed-p">
          <div class="proof-mask closed-m"></div>{" "}
          <div class="proof-container">
            <div class="title-p">
              <div class="img-container">
                <img
                  src="/pub/images/valid-certificate.81baed8.svg"
            ...
            <section class="ps-container scroll-area-proofs ps">
              <ul class="accordion css-accordion">
                <li class="accordion-item">
                  <label class="accordion-item-classic">
                    <img
                      src="/pub/images/avatar-attribute.d71abab.svg"
                      alt="Issuer"
                    />{" "}
                    <div class="label-content">
                      Issued to
                      <br /> <span>Ms Nguyen Kim Ngoc</span>
                    </div>
                  </label>
                </li>{" "}
                <li class="accordion-item">
                  ...
                  <label for="item1" class="accordion-item-hd">
                    <img
                      src="/pub/images/institution.c14f4b8.svg"
                      alt="Issuer"
                    />{" "}
                    <div class="label-content">
                      Issued by
                  ...
                  <div class="accordion-item-bd">
                    <div class="item-bd-container">
                      <div class="address">
                        Address
                        <div>0xD6e0b9aB15AEE84824487B8E594185Bbc10aEc71</div>
                      </div>{" "}
                      <div class="marginTop8">
                        <a
                          href="https://app.mycrypto.com/interact-with-contracts?network=Ethereum&amp;address=0x90bb0B538253d279642439d5f54F336414eC06f7&amp;function=issuers&amp;input=0:21"
                          target="_blank"
                      ...
                      <div class="marginTop8">
                        <a
                          href="https://www.bcdiploma.com/issuers-list.html?issuerId=21&amp;env=production"
                          target="_blank"
                          class="check-proof-button"
                        >
                          <i class="ti-world"></i> View on BCdiploma.com
                        </a>
                      </div>
                    </div>
                  </div>
                ...
                <li class="accordion-item">
                  ...
                  <label for="item2" class="accordion-item-hd">
                    <img
                      src="/pub/images/institution-verified.60238ad.svg"
                      alt="Validator"
                    />{" "}
                    <div class="label-content">
                      Issuer verified by
                      <br />{" "}
                      <span>
                        BCdiploma pour l'Agence Universitaire de la Francophonie
                        (AUF)
                      </span>
                    </div>{" "}
                    <span class="accordion-item-hd-cta">
                  ...
                  <div class="accordion-item-bd">
                    <div class="item-bd-container">
                      <div class="address">
                        Address
                        <div>0x548CDf8bc7E949EA99999962db6c6b428C22a961</div>
                      </div>{" "}
                      <div class="marginTop8">
                        <a
                          href="https://app.mycrypto.com/interact-with-contracts?network=Ethereum&amp;address=0x90bb0B538253d279642439d5f54F336414eC06f7&amp;function=validators&amp;input=0:2"
                          target="_blank"
                          class="check-proof-button"
                        >
                          <i class="icon-check-chain"></i> View on blockchain
                      ...
                      <div class="marginTop8">
                        <a
                          href="https://www.bcdiploma.com/validators-list.html?issuerId=21&amp;env=production"
                          target="_blank"
                          class="check-proof-button"
                        >
                          <i class="ti-world"></i> View on BCdiploma.com
                ...
                <li class="accordion-item">
                  ...
                  <label for="item3" class="accordion-item-hd">
                    <img
                      src="/pub/images/blockchain-proof.8294e18.svg"
                      alt="Data"
                    />{" "}
                    <div class="label-content">
                  ...
                  <div class="accordion-item-bd">
                    <div class="item-bd-data-container">
                      <div class="data">
                        SOCIALIST REPUBLIC OF VIETNAM THE PRESIDENT OF HOA SEN
                        UNIVERSITY has conferred THE DEGREE OF BACHELOR
                        MARKETING Upon: Ms Nguyen Kim Ngoc Date of birth: 09
                        January 1997 Year of graduation: 2020 Degree
                        classification: Very good Mode of study: Full time Ho
                        Chi Minh City, 19 March 2020 Reg. No: DTH/1B0214/2020
                        CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM HIỆU TRƯỞNG TRƯỜNG
                        ĐẠI HỌC HOA SEN cấp BẰNG CỬ NHÂN MARKETING Cho: Bà
                        Nguyễn Kim Ngọc Ngày sinh: 09/01/1997 Năm tốt nghiệp:
                        2020 Xếp loại tốt nghiệp: Giỏi Hình thức đào tạo: Chính
                        quy TP. Hồ Chí Minh, ngày 19 tháng 03 năm 2020 HIỆU
                      ...
                      <div class="marginTop8">
                        <a
                          href="https://etherscan.io/tx/0xb4a0d2c7d39d74ac38e7071280b55e0692b3ef914eafe84fc81d913e3158de72"
                          target="_blank"
                        >
                          View on blockchain
                        </a>
            ...
            <div class="footer">
              <div class="footer-btn">
                <a
                  href="https://www.bcdiploma.com/faq.html"
                  target="_blank"
                  class="check-proof-button"
                >
                  <i class="ti-info-alt"></i>&nbsp;About proofs
                </a>
              </div>{" "}
              <div class="footer-top">
                Powered by
                <a href="https://www.bcdiploma.com" target="_blank">
                  <img
                    src="/pub/images/bcdiploma-logo-header.5b8a760.svg"
                    alt="BCdiploma"
                  />
                </a>
                ©2022
              ...
              <ul class="footer-links">
                <li>
                  <a
                    href="https://www.linkedin.com/company/blockchaincertifieddata/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <li>
                  <a
                    href="https://twitter.com/BCdiploma"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <li>
                  <a
                    href="https://www.youtube.com/channel/UCH4WX09BniorbDeixHR0JNg"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
            ...
            <ul>
              ...
              <li class="social">
                <a
                  ...
                  aria-label="Print"
                  target="_blank"
                  class="social-link matomo_download fz-14"
                >
                  <i class="fas fa-print fz-40"></i> Print
                </a>
              </li>{" "}
            </ul>
          </div>{" "}
          <ul>
            <li>
              <a
                aria-label="Print"
                target="_blank"
                class="download matomo_download fz-14"
              >
                <i class="fas fa-print fz-40"></i> Print
              </a>
            </li>{" "}
        ...
        <div class="global">
          <div class="left">
            ...
            <div class="president bold">
              <div>THE PRESIDENT OF</div> <div>HOA SEN UNIVERSITY</div>
            </div>{" "}
            <div class="confer">has conferred</div>{" "}
            <div class="degree bold">THE DEGREE OF BACHELOR</div>{" "}
            <div class="major bold">MARKETING</div>{" "}
            <div class="list">
              <div class="line">
                <div class="labels">Upon:</div>{" "}
                <div class="name">
                  <span>Ms</span> Nguyen Kim Ngoc
                </div>
              </div>{" "}
              <div class="line">
                <div class="labels">Date of birth:</div>{" "}
                <div class="details">09 January 1997</div>
              </div>{" "}
              <div class="line">
                <div class="labels">Year of graduation:</div>{" "}
                <div class="details">2020</div>
              </div>{" "}
              <div class="line">
                <div class="labels">Degree classification:</div>{" "}
                <div class="details">Very good</div>
              </div>{" "}
              <div class="line">
                <div class="labels">Mode of study:</div>{" "}
                <div class="details">Full time</div>
              </div>
            </div>{" "}
          ...
          <div class="right">
            ...
            <div class="president bold">
              <div>HIỆU TRƯỞNG</div> <div>TRƯỜNG ĐẠI HỌC HOA SEN</div>
            </div>{" "}
            <div class="confer">cấp</div>{" "}
            <div class="degree bold">BẰNG CỬ NHÂN</div>{" "}
            <div class="major bold">MARKETING</div>{" "}
            <div class="list">
              <div class="line">
              ...
              <div class="line">
                ...
                <div class="details">09/01/1997</div>
              </div>{" "}
              <div class="line">
              ...
              <div class="line">
                ...
                <div class="details">Giỏi</div>
              </div>{" "}
              <div class="line">
                <div class="labels">Hình thức đào tạo:</div>{" "}
                <div class="details">Chính quy</div>
              </div>
            </div>{" "}
            <div class="date-town">
